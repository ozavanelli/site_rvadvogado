...
// Mudar Aqui o e-mail
$email_envio = "ti@avilaeng.com.br"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "@vilaeng444AV"; // Senha do e-mail

$site_name = "Rodrigo Vieira Advogado"; // Nome do Site
$site_url = "www.rodrigovieira.com.br"; // URL do Site

$host_smtp = "smtp.skymail.net.br"; // HOST SMTP Ex: smtp.domain.com.br
...
try {
  ...
  $mail->SMTPDebug = 2; // Tire do comentário para debugar
  $mail->isSMTP();
  $mail->Host = $host_smtp;
  $mail->SMTPAuth = true;
  ...
  <html>
    ...
    <body>
      ...
      <div class="form-content" id="form-erro">
        <h2>Um erro ocorreu! <?php $mailer->ErrorInfo; ?></h2>
